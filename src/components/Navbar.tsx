...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full bg-muted/30 backdrop-blur-xl border-t border-primary/20 py-1 md:relative md:w-16 md:h-screen md:border-t-0 md:border-r z-10">
